...
export type HomePageQuery = { __typename?: 'Query', allPosts: Array<{ __typename?: 'PostRecord', title?: string | null, slug: string, excerpt?: string | null, date: string, coverImage: { __typename?: 'FileField', responsiveImage?: (
        { __typename?: 'ResponsiveImage' }
        & { ' $fragmentRefs'?: { 'ResponsiveImageFragmentFragment': ResponsiveImageFragmentFragment } }
      ) | null }, author: { __typename?: 'AuthorRecord', name?: string | null, picture?: { __typename?: 'FileField', responsiveImage?: (
          { __typename?: 'ResponsiveImage' }
          & { ' $fragmentRefs'?: { 'ResponsiveImageFragmentFragment': ResponsiveImageFragmentFragment } }
        ) | null } | null } }> };

export type ResponsiveImageFragmentFragment = { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, base64?: string | null } & { ' $fragmentName'?: 'ResponsiveImageFragmentFragment' };

export type MetaTagsFragmentFragment = { __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string } & { ' $fragmentName'?: 'MetaTagsFragmentFragment' };
